        ...
        <div class="sidebar">
            ...
            <div class="sub-menu">
                <div class="scroll">
                    ...
                    <ul style="margin-right:20px;" class="list-unstyled" data-link="text">
                        ...
                        <div id="text-wrapper" ng-show="getText()">
                            ...
                            <li>
                                ...
                                <input type="color" value="" id="text-lines-bg-color" size="10" class="btn-object-action form-control" bind-value-to="textBgColor">
                            </li>
                            <li><label for="text-font-size">Font size:</label>
                                <input type="range" value="" min="1" max="120" step="1" id="text-font-size" class="btn-object-action form-control" bind-value-to="fontSize">
                            </li>
                            <li><label for="text-line-height">Line height:</label>
                                <input type="range" value="" min="0" max="10" step="0.1" id="text-line-height" class="btn-object-action form-control" bind-value-to="lineHeight">
                            </li>
                            ...
                            <li><button type="button" class="btn btn-object-action" ng-click="toggleBold()" ng-class="{'btn-inverse': isBold()}">
                                    <b>B</b>
                                </button>
                                <button type="button" class="btn btn-object-action" id="text-cmd-italic" ng-click="toggleIyotalic()" ng-class="{'btn-inverse': isItalic()}">
                                    <i>I</i>
                                </button>
                    ...
                    <ul class="list-unstyled" data-link="pencil">
                        <li><button id="drawing-mode" class="btn btn-info" ng-click="setFreeDrawingMode(!getFreeDrawingMode())" ng-class="{'btn-inverse': getFreeDrawingMode()}">
                    ...
                    <ul class="list-unstyled" data-link="property">
                        ...
                        <li>
                            <table>
                                <tr>
                                    <td><button id="send-backwards" class="btn btn-object-action btn-sm" ng-click="sendBackwards()">Send backwards</button></td>
                                    <td>
                                        <button id="send-to-back" class="btn btn-object-action btn-sm" ng-click="sendToBack()">Send to back</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <button id="bring-forward" class="btn btn-object-action btn-sm" ng-click="bringForward()">Bring forwards</button>
                                    </td>
                                    <td>
                                        <button id="bring-to-front" class="btn btn-object-action btn-sm" ng-click="bringToFront()">Bring to front</button>
                                    </td>
                                </tr>
                            </table>
                        </li>
                ...
                <div class="row  ">
                    <div class="col-lg-12">
                        <table>
                            <tr>
                                <td>
                                    <button style="border-radius:0px;" title="Lock Horizontal Movement" class="btn btn-lock btn-object-action btn-sm" ng-click="setVerticalLock(!getVerticalLock())" ng-class="{'btn-inverse': getVerticalLock()}"><i class="fa fa-arrows-alt-h"></i>
                                        {[ getVerticalLock() ? 'Unlock' : 'Lock' ]}
                                    </button>
                                </td>
                                <td>
                                    <div class="col-sm-1">
                                        <button style="border-radius:0px;" title="Lock Vertical Movement" class="btn btn-lock btn-object-action btn-sm" ng-click="setHorizontalLock(!getHorizontalLock())" ng-class="{'btn-inverse': getHorizontalLock()}"><i class="fa fa-arrows-alt-v"></i>
                                            {[ getHorizontalLock() ? 'Unlock' : 'Lock' ]}
                                        </button>
                                </td>
                                <td>
                                    <button style="float: right;margin-right:10px;border-radius:0px;" class="btn btn-object-action" id="remove-selected btn-sm" ng-click="removeSelected()">
