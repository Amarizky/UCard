                ...
                <div class="table-responsive">
                    <table class="table table-flush" id="datatable-basic">
                        ...
                        <tbody>
                            <?php $n = 1;
                            foreach ($image as $i) : ?>
                                <?php $id = $i['image_user_id'];
                                $a = $this->db->get_where('tbl_pelanggan', ['pelanggan_id' => $id])->row_array(); ?>
                                <tr>
                                    <td><?= $n++ ?></td>
                                    <td><?= $a['pelanggan_nama'] ?>
                                    </td>
...
<div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="modal-title-default">Hapus Gambar</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                ...
                <h3>Apakah anda yakin ingin menghapus gambar ini?</h3>
            </div>
